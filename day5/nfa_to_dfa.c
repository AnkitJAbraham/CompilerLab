...
void main()
{
    ...
    {
        printf("\n\tEnter the NFA matrix for input %d:\n", i + 1);
    ...
    printf("\n\tThe transition matrix for the DFA is: \n");
    printf("%-10s|", " ");   
    // % is the format specifier, - means left justified, 10 specifies minimum width and s specifies that it's a string

    for (int i = 0; i < inputs; i++)
        printf("Input %-4d|", i + 1); 
    // same as above, if length is less, then it will be padded with spaces to the right to meet minimum width
    printf("\n");
